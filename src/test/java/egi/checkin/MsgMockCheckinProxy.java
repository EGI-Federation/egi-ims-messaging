...
public class MsgMockCheckinProxy implements QuarkusTestResourceLifecycleManager {

    private static final Logger log = Logger.getLogger(MsgMockCheckinProxy.class);
    private static boolean logRequestBody = false;

    private MsgMockCheckin mockCheckin;
    ...
    public Map<String, String> start() {
        ...
        //logRequestBody = true;
        mockCheckin = new MsgMockCheckin(options()
                            .port(9091)
        ...
        mockCheckin.addMockServiceRequestListener(MsgMockCheckinProxy::requestReceived);
    ...
    public void inject(TestInjector testInjector) {
        testInjector.injectIntoFields(mockCheckin,
                new TestInjector.AnnotatedAndMatchesType(InjectMsgMockCheckin.class, MsgMockCheckin.class));
    }
